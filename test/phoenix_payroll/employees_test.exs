defmodule PhoenixPayroll.EmployeesTest do
  ...
  describe "employees" do
    ...
    test "create_employee/1 with valid data creates a employee" do
      assert {:ok, %Employee{} = employee} = Employees.create_employee(valid_employee_attrs())
      assert employee.name == "some name"
    end

    test "create_employee/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Employees.create_employee(invalid_employee_attrs())
    end
    ...
    test "update_employee/2 with valid data updates the employee" do
      ...
      assert {:ok, %Employee{} = employee} =
               Employees.update_employee(employee, update_employee_attrs())
    ...
    test "update_employee/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Employees.update_employee(employee, invalid_employee_attrs())
